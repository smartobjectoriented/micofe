...
To have a common function header, we also use Doxygen style:
...
The Doxygen Documentation extension for VSCode allows to automatically generate such header, already pre-filled with some information.
To do this, type ``/**`` before a function, and type ``Enter``.
