    ...
    namespace system {
        ...
        public:
            ...
            std::shared_ptr<httpserver::http_response> render_GET(const httpserver::http_request &req) {
                ...
                std::map<int, CapsuleInfo> capsuleInfo;
                ...
                _daemon->container.info(capsuleInfo);
                auto containerNr = capsuleInfo.size();
                ...
                payload_json["ServerVersion"] = "28.3.3";
                ...
                payload_json["Swarm"]["RemoteManagers"] = Json::Value::null;
