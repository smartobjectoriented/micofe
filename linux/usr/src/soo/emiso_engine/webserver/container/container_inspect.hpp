...
#define LOG_PREFIX         "[EMISO:WEBSERVER] "
...
class InspectHandler : public httpserver::http_resource {
      public:
        ...
        std::shared_ptr<httpserver::http_response> render_GET(const httpserver::http_request &req) {
                ...
                cout << LOG_PREFIX "'" << req.get_path()  << "' (" << req.get_method() << ") called" << endl;
                ...
                uint64_t tmp = info.created + 10;
                ptm = std::localtime((const long int *) &tmp);
                ...
                payloadJson["ResolvConfPath"] =
                    "/var/lib/docker/containers/ed856fa2c435daac513a0eff537018034fd0ce2843d84eae4dbfd22203bd10de/resolv.conf";
                payloadJson["HostnamePath"] =
                    "/var/lib/docker/containers/ed856fa2c435daac513a0eff537018034fd0ce2843d84eae4dbfd22203bd10de/hostname";
                payloadJson["HostsPath"] =
                    "/var/lib/docker/containers/ed856fa2c435daac513a0eff537018034fd0ce2843d84eae4dbfd22203bd10de/hosts";
                payloadJson["LogPath"] =
                    "/var/lib/docker/containers/ed856fa2c435daac513a0eff537018034fd0ce2843d84eae4dbfd22203bd10de/"
                    "ed856fa2c435daac513a0eff537018034fd0ce2843d84eae4dbfd22203bd10de-json.log";
                ...
                payloadJson["GraphDriver"]["Data"]["LowerDir"] =
                    "/var/lib/docker/overlay2/5132a5d000dc493f64e1076a4fbefcfd6d04705bb52590b639668d9d82c6652f-init/diff:/var/"
                    "lib/docker/overlay2/0ffcf17c5b7310dcbced19f13a63e8b7566325eaabf34ded9bc67b7c56057fa2/diff";
                ...
                payloadJson["NetworkSettings"]["SandboxID"] =
                    "a7c9c2fe37e94ade66a9969d7070fe5d3e894753bb20fe14953692074af9ef00";
                ...
                payloadJson["NetworkSettings"]["Networks"]["bridge"]["NetworkID"] =
                    "1cacb396f2c32029fe35d73d8d061575bc69baadc15c1cc8fa596aa2ac3c1eaa";
                ...
                auto response = std::make_shared<httpserver::string_response>(
                    payload_str, httpserver::http::http_utils::http_ok, "application/json");
                return response;
        }
